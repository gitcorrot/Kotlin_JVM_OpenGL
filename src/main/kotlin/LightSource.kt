...
class LightSource(mesh: Mesh) : Model(mesh) {
    companion object {
        val TAG: String = this::class.java.name
        val shaderProgram = ShaderProgram()

        init {
            val vertexShaderString = ResourcesUtils.loadStringFromFile("Shaders/light_vertex_shader.glsl")
            val fragmentShaderString = ResourcesUtils.loadStringFromFile("Shaders/light_fragment_shader.glsl")
