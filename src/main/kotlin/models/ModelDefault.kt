...
class ModelDefault(mesh: Mesh) : Model(mesh) {
    companion object {
        val TAG: String = this::class.java.name
        val shaderProgram = ShaderProgram()

        private const val vertexShaderPath = "/Shaders/model_default_vertex_shader.glsl"
        private const val fragmentShaderPath = "/Shaders/model_default_fragment_shader.glsl"
